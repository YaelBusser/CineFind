        ...
        <div class="block-titleTop10" :style="`opacity: ${opacityTop10}; margin-bottom: ${positionBlockTitle}px`"
          ...
          <svg viewBox="0 0 28 30" class="svg-icon svg-icon-top-10-badge">
            ...
            <path
                ...
                fill="#FFFFFF"></path>
            <polygon fill="#FFFFFF"
                     points="8.86676 23.9094206 8.86676 16.6651418 6.88122061 17.1783055 6.88122061 14.9266812 11.0750267 13.8558085 11.0750267 23.9094206"></polygon>
            <path
            ...
            <path
                ...
                fill="#FFFFFF"></path>
            <polygon fill="#FFFFFF"
                     points="8.4639503 12.8342327 6.65837455 13.2666206 6.65837455 7.77862061 4.65323515 7.77862061 4.65323515 6.22012364 10.4690897 6.22012364 10.4690897 7.77862061 8.4639503 7.77862061"></polygon>
          </svg>
          <p>N°{{ random + 1 }} des films aujourd'hui</p>
        </div>
...
export default {
  ...
  methods: {
    ...
    async moviePopular() {
      fetch("https://api.themoviedb.org/3/trending/movie/day?api_key=9f49de7ae4e7847f4cd272851ed07488&language=fr&page=1")
          ...
          .then(data => {
            ...
            this.theMovie = this.movie[this.random];
    ...
    async videoMoviePopular() {
      fetch(`https://api.themoviedb.org/3/movie/${this.theMovie.id}/videos?api_key=9f49de7ae4e7847f4cd272851ed07488&language=fr`)
          .then(response => response.json())
          .then(data => {
